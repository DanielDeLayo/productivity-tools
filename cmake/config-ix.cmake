...
if(APPLE)
  ...
  list_intersect(CILKSCALE_SUPPORTED_ARCH
    ...
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  list_intersect(CILKIAF_SUPPORTED_ARCH
    ALL_CILKIAF_SUPPORTED_ARCH
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(CILKIAF_SUPPORTED_ARCH ${ALL_CILKIAF_SUPPORTED_ARCH})
endif()
...
if (CILKIAF_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin|FreeBSD")
  set(CILKTOOLS_HAS_CILKIAF TRUE)
else()
  set(CILKTOOLS_HAS_CILKIAF FALSE)
endif()
